 ...
 * on a fixed timer. The entrance choreography below (icon pop -> curve draw
 * -> wordmark fade-up -> tagline fade-up) is self-contained and runs once
 * regardless of when that navigation actually happens.
 */
@Composable
fun SplashScreen() {
